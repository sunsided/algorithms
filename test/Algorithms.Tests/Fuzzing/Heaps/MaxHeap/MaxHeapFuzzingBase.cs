...
{
    /// <summary>
    /// Base class for fuzzing <see cref="MaxHeap{T}"/>.
    /// </summary>
    public abstract class MaxHeapFuzzingBase : HeapFuzzingBase
    {
        protected MaxHeapFuzzingBase()
            : base(new MaxHeap<NumericalItem>())
        {}
